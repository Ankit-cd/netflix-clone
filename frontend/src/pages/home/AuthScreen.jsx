...
import strangerimage from '../../assets/stranger-things-lg.png';
import strangersmallimage from '../../assets/stranger-things-sm.png';
...
const AuthScreen = () => {
  ...
  return (
    ...
    <header className='max-w-6xl mx-auto flex items-center justify-between p-4 pb-10'>
		<img src={netflixlogo} alt='Netflix Logo' className='w-32 md:w-52' />
    ...
    <div className='py-10 bg-black text-white'>
        <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
            ...
            <div className='flex-1 relative'>
				<img src={tvimage} alt='Tv image' className='mt-4 z-20 relative' />
				<video
        ...
        <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2'>
            ...
            <div className='flex-1'>
                <div className='relative'>
                    <img src={strangerimage} alt="stranger things"
                    className='mt-4' />
                    ...
                    <div className='flex items-center gap-2 absolute bottom-5 left-1/2 -translate-x-1/2 bg-black w-3/4 lg:w-1/2 h-24 border border-slate-500 rounded-md px-2'>
                        <img src={strangersmallimage} alt="stranger small" className='h-full'/>
                        <div className='flex justify-between items-center w-full'>
                            <div className='flex flex-col gap-0'>
                                <span className='text-md lg:text-lg font-bold'>Stranger Things</span>
                                <span className='text-s text-blue-500'>Downloading...</span>
                            </div>
                            <img src={download} alt="download" className='h-12 ' />
                        </div>
    ...
    <div className='py-10 bg-black text-white'>
        <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
            ...
            <div className='flex-1 relative overflow-hidden'>
				<img src={devicepile} alt='device image' className='mt-4 z-20 relative' />
				<video
